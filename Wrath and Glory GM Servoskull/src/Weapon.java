public class Weapon extends Wargear{
    private String name;
    private int damage;
    ...
    public Weapon(String name, int damage, int extraDice, int armorPiercing, int[] range, w_Trait[] traits) {
        this.name = name;
        this.damage = damage;
    ...
    class w_Trait {
        private final Trait agonising = new Trait("Agonising", "Designed to inflict maximum pain, these weapons damage mind and morale as much as body", "Every wound inflicted by this weapon inflicts 1 Shock.", 0);
        private final Trait arc = new Trait("Arc", "The deadly electrical discharge of Arc weapons scrambles vehicle technology", "This weapon gains +ED equal to the rating of the trait when attacking vehicles", 1);
        private final Trait assault = new Trait("Assault", "Optimized for firing whilst rushing righteously towards the enemy.", "You can fire an Assault weapon as part of a Sprint but take a +2 DN penalty to the Attack", 2);
        private final Trait blast = new Trait("Blast", "Explosive weapons can devastate multiple enemies\r\n" + //
        ...
        public Trait getAssault() {
            return assault;
        }

        public Trait getBlast() {
            return blast;
        }

        public Trait getBrutal() {
            return brutal;
        }

        public Trait getForce() {
            return force;
        }

        public Trait getFlamer() {
            return flamer;
        }
    }
